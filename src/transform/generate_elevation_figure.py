"""
src/transform/generate_elevation_figure.py — Elevation Distribution Plotter
===========================================================================
Generates a professional academic figure (boxplot + stripplot) showing the
elevation distribution across different railway asset types.

Architecture Position (Reporting / Data Viz):
    - Consumes the tabular summary generated by `derive_all_assets_elevation.py`.
    - Uses standard `viz.py` styles to produce a high-quality chart for reports.

Relationship with other files:
    - Reads: `report/tables/Table01_Asset_Elevation_Summary.csv`
    - Uses: `src.utils.viz` for styling and saving.
    - Writes: `report/figures/Fig01_Elevation_Distribution.png`

Example Usage:
    python src/transform/generate_elevation_figure.py
"""
import pandas as pd
